...
export default function Nexus() {
    return(
        <div className='nexus-father'>
            ...
            <div className='nexus-cat'>
                <a className='nexus-categories' href='/nexusCorporateTraining'>Corporate Training</a>
                
                <a className='nexus-categories' href='/nexusEvents'>Events</a>   
            </div>
        </div>
    )
